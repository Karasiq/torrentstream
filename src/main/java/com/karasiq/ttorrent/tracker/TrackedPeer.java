...
public class TrackedPeer extends Peer {
	 ...
	 */
	public TrackedPeer(com.karasiq.ttorrent.common.Torrent torrent, String ip, int port,
					   ByteBuffer peerId) {
	 ...
	 */
	public com.karasiq.ttorrent.bcodec.BEValue toBEValue() throws UnsupportedEncodingException {
		Map<String, com.karasiq.ttorrent.bcodec.BEValue> peer = new HashMap<String, com.karasiq.ttorrent.bcodec.BEValue>();
		if (this.hasPeerId()) {
			peer.put("peer id", new com.karasiq.ttorrent.bcodec.BEValue(this.getPeerId().array()));
		}
		peer.put("ip", new com.karasiq.ttorrent.bcodec.BEValue(this.getIp(), com.karasiq.ttorrent.common.Torrent.BYTE_ENCODING));
		peer.put("port", new com.karasiq.ttorrent.bcodec.BEValue(this.getPort()));
		return new com.karasiq.ttorrent.bcodec.BEValue(peer);
	}
}
