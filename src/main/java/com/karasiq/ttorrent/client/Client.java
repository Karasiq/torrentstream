 ...
 */
package com.karasiq.ttorrent.client;
...
public class Client extends Observable implements Runnable,
		com.karasiq.ttorrent.client.announce.AnnounceResponseListener, IncomingConnectionListener, com.karasiq.ttorrent.client.peer.PeerActivityListener {
	...
	private com.karasiq.ttorrent.common.Peer self;
	...
	private com.karasiq.ttorrent.client.announce.Announce announce;
	private ConcurrentMap<String, com.karasiq.ttorrent.client.peer.SharingPeer> peers;
	private ConcurrentMap<String, com.karasiq.ttorrent.client.peer.SharingPeer> connected;
	...
	public Client(InetAddress address, SharedTorrent torrent)
		...
		this.self = new com.karasiq.ttorrent.common.Peer(
			this.service.getSocketAddress()
				.getAddress().getHostAddress(),
			(short)this.service.getSocketAddress().getPort(),
			ByteBuffer.wrap(id.getBytes(com.karasiq.ttorrent.common.Torrent.BYTE_ENCODING)));

		// Initialize the announce request thread, and register ourselves to it
		// as well.
		this.announce = new com.karasiq.ttorrent.client.announce.Announce(this.torrent, this.self);
		...
		this.peers = new ConcurrentHashMap<String, com.karasiq.ttorrent.client.peer.SharingPeer>();
		this.connected = new ConcurrentHashMap<String, com.karasiq.ttorrent.client.peer.SharingPeer>();
	 ...
	 */
	public com.karasiq.ttorrent.common.Peer getPeerSpec() {
		return this.self;
	}
	 ...
	 */
	public Set<com.karasiq.ttorrent.client.peer.SharingPeer> getPeers() {
		return new HashSet<com.karasiq.ttorrent.client.peer.SharingPeer>(this.peers.values());
	}
	...
	public void run() {
		...
		for (com.karasiq.ttorrent.client.peer.SharingPeer peer : this.connected.values()) {
			peer.unbind(true);
		}
	 ...
	 * </p>
	 *
	 * @param search The {@link com.karasiq.ttorrent.common.Peer} specification.
	 */
	private com.karasiq.ttorrent.client.peer.SharingPeer getOrCreatePeer(com.karasiq.ttorrent.common.Peer search) {
		com.karasiq.ttorrent.client.peer.SharingPeer peer;
		...
		synchronized (this.peers) {
			...
			peer = new com.karasiq.ttorrent.client.peer.SharingPeer(search.getIp(), search.getPort(),
	 ...
	 */
	private Comparator<com.karasiq.ttorrent.client.peer.SharingPeer> getPeerRateComparator() {
		if (ClientState.SHARING.equals(this.state)) {
			return new com.karasiq.ttorrent.client.peer.SharingPeer.DLRateComparator();
		} else if (ClientState.SEEDING.equals(this.state)) {
			return new com.karasiq.ttorrent.client.peer.SharingPeer.ULRateComparator();
		} else {
	...
	private synchronized void unchokePeers(boolean optimistic) {
		...
		// not connected to.
		TreeSet<com.karasiq.ttorrent.client.peer.SharingPeer> bound = new TreeSet<com.karasiq.ttorrent.client.peer.SharingPeer>(
		...
		int downloaders = 0;
		Set<com.karasiq.ttorrent.client.peer.SharingPeer> choked = new HashSet<com.karasiq.ttorrent.client.peer.SharingPeer>();

		// We're interested in the top downloaders first, so use a descending
		// set.
		for (com.karasiq.ttorrent.client.peer.SharingPeer peer : bound.descendingSet()) {
		...
		// optimistic unchoke.
		if (choked.size() > 0) {
			com.karasiq.ttorrent.client.peer.SharingPeer randomPeer = choked.toArray(
					new com.karasiq.ttorrent.client.peer.SharingPeer[0])[this.random.nextInt(choked.size())];

			for (com.karasiq.ttorrent.client.peer.SharingPeer peer : choked) {
	 ...
	 */
	@Override
	public void handleDiscoveredPeers(List<com.karasiq.ttorrent.common.Peer> peers) {
		...
		for (com.karasiq.ttorrent.common.Peer peer : peers) {
			...
			//     something).
			com.karasiq.ttorrent.client.peer.SharingPeer match = this.getOrCreatePeer(peer);
			if (this.isSeed()) {
				continue;
			}
	 ...
	 * @see com.karasiq.ttorrent.client.peer.SharingPeer
	 */
	@Override
	public void handleNewPeerConnection(SocketChannel channel, byte[] peerId) {
		com.karasiq.ttorrent.common.Peer search = new com.karasiq.ttorrent.common.Peer(
		...
		com.karasiq.ttorrent.client.peer.SharingPeer peer = this.getOrCreatePeer(search);
	 ...
	 */
	@Override
	public void handleFailedConnection(com.karasiq.ttorrent.client.peer.SharingPeer peer, Throwable cause) {
	...
	@Override
	public void handlePeerChoked(com.karasiq.ttorrent.client.peer.SharingPeer peer) { /* Do nothing */ }

	@Override
	public void handlePeerReady(com.karasiq.ttorrent.client.peer.SharingPeer peer) { /* Do nothing */ }

	@Override
	public void handlePieceAvailability(com.karasiq.ttorrent.client.peer.SharingPeer peer,
										Piece piece) { /* Do nothing */ }

	@Override
	public void handleBitfieldAvailability(com.karasiq.ttorrent.client.peer.SharingPeer peer,
										   BitSet availablePieces) { /* Do nothing */ }

	@Override
	public void handlePieceSent(com.karasiq.ttorrent.client.peer.SharingPeer peer,
								Piece piece) { /* Do nothing */ }
	 ...
	 */
	@Override
	public void handlePieceCompleted(com.karasiq.ttorrent.client.peer.SharingPeer peer, Piece piece)
		throws IOException {
		synchronized (this.torrent) {
			if (piece.isValid()) {
				...
				com.karasiq.ttorrent.common.protocol.PeerMessage have = com.karasiq.ttorrent.common.protocol.PeerMessage.HaveMessage.craft(piece.getIndex());
				for (com.karasiq.ttorrent.client.peer.SharingPeer remote : this.connected.values()) {
					remote.send(have);
				}
			...
			if (this.torrent.isComplete()) {
				...
				try {
					this.announce.getCurrentTrackerClient()
						.announce(com.karasiq.ttorrent.common.protocol.TrackerMessage
							.AnnounceRequestMessage
							.RequestEvent.COMPLETED, true);
				} catch (com.karasiq.ttorrent.client.announce.AnnounceException ae) {
	...
	@Override
	public void handlePeerDisconnected(com.karasiq.ttorrent.client.peer.SharingPeer peer) {
	...
	@Override
	public void handleIOException(com.karasiq.ttorrent.client.peer.SharingPeer peer, IOException ioe) {
