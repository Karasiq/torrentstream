...
public class Handshake {
	...
	public static Handshake parse(ByteBuffer buffer)
		...
		if (!Handshake.BITTORRENT_PROTOCOL_IDENTIFIER.equals(
					new String(pstr, com.karasiq.ttorrent.common.Torrent.BYTE_ENCODING))) {
	...
	public static Handshake craft(byte[] torrentInfoHash,
		...
		try {
			...
			buffer.put(Handshake
					.BITTORRENT_PROTOCOL_IDENTIFIER.getBytes(com.karasiq.ttorrent.common.Torrent.BYTE_ENCODING));
			buffer.put(reserved);
			buffer.put(infoHash);
			buffer.put(peerId);
