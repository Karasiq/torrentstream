...
public abstract class TrackerClient {
	...
	protected final com.karasiq.ttorrent.common.Peer peer;
	protected final URI tracker;

	public TrackerClient(SharedTorrent torrent, com.karasiq.ttorrent.common.Peer peer, URI tracker) {
	 ...
	 */
	public abstract void announce(com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceRequestMessage.RequestEvent event,
	...
	protected String formatAnnounceEvent(
		...
		return com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceRequestMessage.RequestEvent.NONE.equals(event)
			? ""
	 ...
	 * </p>
	 *
	 * @param message The incoming {@link com.karasiq.ttorrent.common.protocol.TrackerMessage}.
	...
	protected void handleTrackerAnnounceResponse(com.karasiq.ttorrent.common.protocol.TrackerMessage message,
		...
		if (message instanceof com.karasiq.ttorrent.common.protocol.TrackerMessage.ErrorMessage) {
			com.karasiq.ttorrent.common.protocol.TrackerMessage.ErrorMessage error = (com.karasiq.ttorrent.common.protocol.TrackerMessage.ErrorMessage)message;
			throw new AnnounceException(error.getReason());
		}

		if (! (message instanceof com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceResponseMessage)) {
		...
		com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceResponseMessage response =
			(com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceResponseMessage)message;
	 ...
	 */
	protected void fireDiscoveredPeersEvent(List<com.karasiq.ttorrent.common.Peer> peers) {
		for (AnnounceResponseListener listener : this.listeners) {
