...
public class HTTPTrackerClient extends TrackerClient {
	 ...
	 *
	 * <p>
	 * All registered {@link com.karasiq.ttorrent.client.announce.AnnounceResponseListener} objects are then fired
	...
	public void announce(AnnounceRequestMessage.RequestEvent event,
		boolean inhibitEvents) throws com.karasiq.ttorrent.client.announce.AnnounceException {
		...
		URL target = null;
		try {
			com.karasiq.ttorrent.common.protocol.http.HTTPAnnounceRequestMessage request =
				this.buildAnnounceRequest(event);
			target = request.buildAnnounceURL(this.tracker.toURL());
		} catch (MalformedURLException mue) {
			throw new com.karasiq.ttorrent.client.announce.AnnounceException("Invalid announce URL (" +
				mue.getMessage() + ")", mue);
		} catch (MessageValidationException mve) {
			throw new com.karasiq.ttorrent.client.announce.AnnounceException("Announce request creation violated " +
				"expected protocol (" + mve.getMessage() + ")", mve);
		} catch (IOException ioe) {
			throw new com.karasiq.ttorrent.client.announce.AnnounceException("Error building announce request (" +
				ioe.getMessage() + ")", ioe);
		}
		...
		// any further.
		if (in == null) {
			throw new com.karasiq.ttorrent.client.announce.AnnounceException("No response or unreachable tracker!");
		}
		...
		try {
			...
			com.karasiq.ttorrent.common.protocol.http.HTTPTrackerMessage message =
				com.karasiq.ttorrent.common.protocol.http.HTTPTrackerMessage.parse(ByteBuffer.wrap(baos.toByteArray()));
			this.handleTrackerAnnounceResponse(message, inhibitEvents);
		} catch (IOException ioe) {
			throw new com.karasiq.ttorrent.client.announce.AnnounceException("Error reading tracker response!", ioe);
		} catch (MessageValidationException mve) {
			throw new com.karasiq.ttorrent.client.announce.AnnounceException("Tracker message violates expected " +
	 ...
	 * @return Returns an instance of a {@link com.karasiq.ttorrent.common.protocol.http.HTTPAnnounceRequestMessage}
	 ...
	 */
	private com.karasiq.ttorrent.common.protocol.http.HTTPAnnounceRequestMessage buildAnnounceRequest(
		AnnounceRequestMessage.RequestEvent event)
		throws UnsupportedEncodingException, IOException,
			MessageValidationException {
		// Build announce request message
		return com.karasiq.ttorrent.common.protocol.http.HTTPAnnounceRequestMessage.craft(
