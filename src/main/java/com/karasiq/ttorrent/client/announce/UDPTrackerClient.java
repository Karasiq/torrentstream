 ...
 */
package com.karasiq.ttorrent.client.announce;
...
public class UDPTrackerClient extends TrackerClient {
	 ...
	 * @param torrent
	 */
	protected UDPTrackerClient(com.karasiq.ttorrent.client.SharedTorrent torrent, com.karasiq.ttorrent.common.Peer peer, URI tracker)
	...
	@Override
	public void announce(com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceRequestMessage.RequestEvent event,
		...
		int maxAttempts = com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceRequestMessage.RequestEvent
			...
			while (++attempts <= maxAttempts) {
				...
				switch (state) {
					case CONNECT_REQUEST:
						this.send(com.karasiq.ttorrent.common.protocol.udp.UDPConnectRequestMessage
							.craft(this.transactionId).getData());

						try {
							this.handleTrackerConnectResponse(
								com.karasiq.ttorrent.common.protocol.udp.UDPTrackerMessage.UDPTrackerResponseMessage
		...
		} catch (com.karasiq.ttorrent.common.protocol.TrackerMessage.MessageValidationException mve) {
	 ...
	 */
	@Override
	protected void handleTrackerAnnounceResponse(com.karasiq.ttorrent.common.protocol.TrackerMessage message,
												 boolean inhibitEvents) throws AnnounceException {
	...
	private com.karasiq.ttorrent.common.protocol.udp.UDPAnnounceRequestMessage buildAnnounceRequest(
		com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceRequestMessage.RequestEvent event) {
		return com.karasiq.ttorrent.common.protocol.udp.UDPAnnounceRequestMessage.craft(
			this.connectionId,
			transactionId,
			...
			0,
			com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceRequestMessage.DEFAULT_NUM_WANT,
			this.peer.getPort());
	}
	 ...
	 */
	private void validateTrackerResponse(com.karasiq.ttorrent.common.protocol.TrackerMessage message)
		throws AnnounceException {
		if (message instanceof com.karasiq.ttorrent.common.protocol.TrackerMessage.ErrorMessage) {
			throw new AnnounceException(((com.karasiq.ttorrent.common.protocol.TrackerMessage.ErrorMessage)message).getReason());
		}

		if (message instanceof com.karasiq.ttorrent.common.protocol.udp.UDPTrackerMessage &&
			(((com.karasiq.ttorrent.common.protocol.udp.UDPTrackerMessage)message).getTransactionId() != this.transactionId)) {
	 ...
	 * connection request.
	 */
	private void handleTrackerConnectResponse(com.karasiq.ttorrent.common.protocol.TrackerMessage message)
		throws AnnounceException {
		this.validateTrackerResponse(message);

		if (! (message instanceof com.karasiq.ttorrent.common.protocol.TrackerMessage.ConnectionResponseMessage)) {
			throw new AnnounceException("Unexpected tracker message type " +
				message.getType().name() + "!");
		}

		com.karasiq.ttorrent.common.protocol.udp.UDPConnectResponseMessage connectResponse =
			(com.karasiq.ttorrent.common.protocol.udp.UDPConnectResponseMessage)message;
