...
public class Piece implements Comparable<Piece> {
	 ...
	 * validation).
	 */
	public Piece(com.karasiq.ttorrent.client.storage.TorrentByteStorage bucket, int index, long offset,
	 ...
	 */
	public void seenAt(com.karasiq.ttorrent.client.peer.SharingPeer peer) {
		this.seen++;
	}
	 ...
	 */
	public void noLongerAt(com.karasiq.ttorrent.client.peer.SharingPeer peer) {
		this.seen--;
	}
	...
	public synchronized boolean validate() throws IOException {
		...
		buffer.get(data);
		this.valid = Arrays.equals(com.karasiq.ttorrent.common.Torrent.hash(data), this.hash);
