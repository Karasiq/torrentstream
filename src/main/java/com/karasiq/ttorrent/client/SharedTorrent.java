 ...
 * @author mpetazzoni
 */
public class SharedTorrent extends com.karasiq.ttorrent.common.Torrent implements com.karasiq.ttorrent.client.peer.PeerActivityListener {
	...
	private final com.karasiq.ttorrent.client.storage.TorrentByteStorage bucket;
	...
	public SharedTorrent(ActorRef writer, byte[] torrent, File parent, boolean seeder)
		...
		try {
			...
			if (this.piecesHashes.capacity() / com.karasiq.ttorrent.common.Torrent.PIECE_HASH_SIZE *
	 ...
	 */
	public static SharedTorrent fromFile(ActorRef writer, File source, File parent)
		throws IOException {
		byte[] data = FileUtils.readFileToByteArray(source);
		return new SharedTorrent(writer, data, parent, false);
	}
	...
	public synchronized void init() throws InterruptedException, IOException {
		...
		try {
			...
			for (int idx=0; idx<nPieces; idx++) {
				byte[] hash = new byte[com.karasiq.ttorrent.common.Torrent.PIECE_HASH_SIZE];
	 ...
	 * </p>
	 *
	 * @see com.karasiq.ttorrent.client.storage.TorrentByteStorage#finish
	 */
	 ...
	 */
	@Override
	public synchronized void handlePeerChoked(com.karasiq.ttorrent.client.peer.SharingPeer peer) {
...
//		interesting.andNot(this.requestedPieces);
	 ...
	 */
	@Override
	public synchronized void handlePieceAvailability(com.karasiq.ttorrent.client.peer.SharingPeer peer,
													 Piece piece) {
	 ...
	 */
	@Override
	public synchronized void handleBitfieldAvailability(com.karasiq.ttorrent.client.peer.SharingPeer peer,
	 ...
	 */
	@Override
	public synchronized void handlePieceSent(com.karasiq.ttorrent.client.peer.SharingPeer peer, Piece piece) {
	 ...
	 */
	@Override
	public synchronized void handlePieceCompleted(com.karasiq.ttorrent.client.peer.SharingPeer peer,
...
//		this.downloaded += piece.size();
	 ...
	 */
	@Override
	public synchronized void handlePeerDisconnected(com.karasiq.ttorrent.client.peer.SharingPeer peer) {
	...
	@Override
	public synchronized void handleIOException(com.karasiq.ttorrent.client.peer.SharingPeer peer,
