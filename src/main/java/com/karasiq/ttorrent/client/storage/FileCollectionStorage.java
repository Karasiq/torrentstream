...
public class FileCollectionStorage implements TorrentByteStorage {
	...
	private final List<com.karasiq.ttorrent.client.storage.FileStorage> files;
	private final long size;

	/**
	 * Initialize a new multi-file torrent byte storage.
	 *
	 * @param files The list of individual {@link com.karasiq.ttorrent.client.storage.FileStorage}
	 * objects making up the torrent.
	 * @param size The total size of the torrent data, in bytes.
	 */
	public FileCollectionStorage(List<com.karasiq.ttorrent.client.storage.FileStorage> files,
		long size) {
		this.files = files;
		this.size = size;
	...
	public void close() throws IOException {
		for (com.karasiq.ttorrent.client.storage.FileStorage file : this.files) {
			file.close();
		}
	}
	 ...
	 * on one of the underlying {@link com.karasiq.ttorrent.client.storage.FileStorage}s.
	 * </p>
	 *
	 * @author dgiffin
	 * @author mpetazzoni
	...
	private static class FileOffset {
		...
		public final com.karasiq.ttorrent.client.storage.FileStorage file;
		public final long offset;
		public final long length;

		FileOffset(com.karasiq.ttorrent.client.storage.FileStorage file, long offset, long length) {
			this.file = file;
			this.offset = offset;
			this.length = length;
		}
	 ...
	 * com.karasiq.ttorrent.client.storage.FileStorage}s impacted by the operation, bundled with their
