...
import com.karasiq.ttorrent.bcodec.BEncoder;
import com.karasiq.ttorrent.bcodec.InvalidBEncodingException;
import com.karasiq.ttorrent.common.Peer;
import com.karasiq.ttorrent.common.protocol.TrackerMessage.AnnounceResponseMessage;
...
public class HTTPAnnounceResponseMessage extends HTTPTrackerMessage
	 ...
	 *
	 * @param peers The list of {@link com.karasiq.ttorrent.bcodec.BEValue}s dictionaries describing the
	 ...
	 */
	private static List<Peer> toPeerList(List<com.karasiq.ttorrent.bcodec.BEValue> peers)
		throws InvalidBEncodingException {
		List<Peer> result = new LinkedList<Peer>();

		for (com.karasiq.ttorrent.bcodec.BEValue peer : peers) {
			Map<String, com.karasiq.ttorrent.bcodec.BEValue> peerInfo = peer.getMap();
			result.add(new Peer(
				peerInfo.get("ip").getString(com.karasiq.ttorrent.common.Torrent.BYTE_ENCODING),
	...
	public static HTTPAnnounceResponseMessage craft(int interval,
		...
		Map<String, com.karasiq.ttorrent.bcodec.BEValue> response = new HashMap<String, com.karasiq.ttorrent.bcodec.BEValue>();
		response.put("interval", new com.karasiq.ttorrent.bcodec.BEValue(interval));
		response.put("complete", new com.karasiq.ttorrent.bcodec.BEValue(complete));
		response.put("incomplete", new com.karasiq.ttorrent.bcodec.BEValue(incomplete));
		...
		response.put("peers", new com.karasiq.ttorrent.bcodec.BEValue(data.array()));
